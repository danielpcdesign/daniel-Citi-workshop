...
| M5 | Incident CRUD + workflow | The five statuses, with transitions enforced server-side | In progress — phase A: transition rules and visibility policy as pure, fully tested modules; CRUD, transitions, assignment, escalation next |
