...
- **The dashboard nav and the hotspots heading disagree on wording.** The section nav (commit `b16fe04`, 2026-09-24) labels the location-breakdown entry "Where problems occur"; the `HotspotList` heading it scrolls to reads "Where problems recur". Cosmetic, but visible side by side. Not fixed — which wording stands is a pending user call, not settled here.
